...
st.markdown(
    """
    <h1 style='text-align: center; color: #FFC0CB;'>
...
st.markdown(
    """
    <p style='text-align: center; font-size: 16px; color: #FF69B4;'>
...
st.markdown(
    """
    <h3 style='color: #FF69B4;'>Feature Descriptions</h3>
    <p style='color: #333;'>
...
st.markdown(
    """
    <h3 style='color: #FF69B4;'>Enter Feature Values Below</h3>
    """,
    unsafe_allow_html=True,
)
